(function () {
  ...
  (self["webpackChunkboardGames"] = self["webpackChunkboardGames"] || []).push([["src_app_games_space_space_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _SpacePage = /*#__PURE__*/function () {
        ...
        _createClass(SpacePage, [{
          ...
          key: "goToBuyTech",
          value: function goToBuyTech(cps) {
        ...
        _createClass(DbService, [{
          ...
          value: function getTechOwner() {
            ...
            return this.storage.executeSql('SELECT * FROM techs where Buy = 1', []).then(function (res) {
              ...
              _this5.techOwnerList.next(items);
            });
          }
        }, {
          key: "getTech",
          value: function getTech() {
            ...
            return this.storage.executeSql('SELECT * FROM techs where Buy = 0', []).then(function (res) {
              ...
              _this6.techList.next(items);
            });
          }
        }, {
          key: "buyTech",
          value: function buyTech(id, buy) {
            var _this7 = this;

            var data = [buy];
            return this.storage.executeSql("UPDATE techs SET Buy = ? WHERE Id = ".concat(id), data).then(function (data) {
              _this7.getTech();
          ...
          value: function getShipsOwner() {
            ...
            return this.storage.executeSql('SELECT * FROM ships where Buy = 1', []).then(function (res) {
              ...
              _this9.shipListOwner.next(items);
            });
          }
        }, {
          key: "buyShip",
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = ".headerSpace {\n  display: contents;\n}\n\n.headerTitle {\n  text-align: center;\n  margin: 2rem;\n}\n\nion-menu-button {\n  color: var(--ion-color-primary);\n}\n\n.menuButton {\n  display: flex;\n  justify-content: center;\n}\n\n.inputCp {\n  text-align: center;\n  position: absolute;\n  left: 26%;\n}\n\n.returnClass {\n  text-align: center;\n  margin-top: 0.3rem;\n  font-size: x-large;\n}\n\n.carryOver {\n  margin-top: 1rem;\n  text-align: center;\n  padding: 0;\n}\n\n.carry {\n  margin-top: 2em;\n}\n\n.colony {\n  margin-top: 7em;\n  text-align: center;\n  display: flex;\n  justify-content: center;\n}\n\n.mineral {\n  margin-top: 12em;\n}\n\n.pipe {\n  margin-top: 17em;\n}\n\n.manteninance {\n  margin-top: 25em;\n  color: red;\n}\n\n.turnOrderBid {\n  margin-top: 29em;\n  color: red;\n}\n\n.total {\n  position: absolute;\n  margin-top: 22em;\n  background: gainsboro;\n  text-align: center;\n  width: 100%;\n}\n\n.formClass {\n  margin: 0;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
