...
INSERT or IGNORE INTO ships (Type, Class, CP, Attack_Strength, Defense_Strength, Hull_Size, Description) VALUES ('SC #1', 'Scout', 6, 'E3 (A6-8)', '0', 1, 'May have increased firepower versus fighters depending on level of point defense technology - A6 at PD1, A7 at PD2, A8 at PD3.');
INSERT or IGNORE INTO ships (Type, Class, CP, Attack_Strength, Defense_Strength, Hull_Size, Description) VALUES ('SC #2', 'Scout', 6, 'E3 (A6-8)', '0', 1, 'May have increased firepower versus fighters depending on level of point defense technology - A6 at PD1, A7 at PD2, A8 at PD3.');
INSERT or IGNORE INTO ships (Type, Class, CP, Attack_Strength, Defense_Strength, Hull_Size, Description) VALUES ('SC #3', 'Scout', 6, 'E3 (A6-8)', '0', 1, 'May have increased firepower versus fighters depending on level of point defense technology - A6 at PD1, A7 at PD2, A8 at PD3.');
...
INSERT or IGNORE INTO ships (Type, Class, CP, Attack_Strength, Defense_Strength, Hull_Size, Description) VALUES ('SY', 'Ship Yard', 6, 'C3', '0', 1, '(0 - Mant) Allows ships to be built.May only be built at a colony that produced income.Only one may be built at any one colony per economic phase.SYs are automatically upgraded to the highest technology for free(obviously limited by hull size).');
...
INSERT or IGNORE  INTO techs ( Name, Value, Cost, Description) VALUES ('Attack', 0, 0, 'Add 0 to a ship''s attack rating when in battle');
...
INSERT or IGNORE  INTO techs ( Name, Value, Cost, Description) VALUES ( 'Ships Size', 1, 0, 'Can build SC,CO,SY,Miner,Decoy,MS Pipeline');
...
INSERT or IGNORE  INTO techs ( Name, Value, Cost, Description) VALUES ( 'Move', 1, 0, 'Can move 1 hex per turn');
...
INSERT or IGNORE  INTO techs ( Name, Value, Cost, Description) VALUES ( 'Ship Yards', 1, 0, 'Can build a 1 hull point per SY');
